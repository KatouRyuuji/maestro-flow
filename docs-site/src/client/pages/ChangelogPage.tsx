...
const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'refactor', text_en: 'Blocked diagnostics no longer participate in receipt freshness commitments, preventing platform/path wording drift from staling unrelated healthy candidates; release-machine focused proofs use explicit 30-second test and hook limits', text_zh: 'blocked 诊断文案不再参与 receipt freshness 承诺，避免平台/路径文案漂移使无关健康候选变 stale；release-machine 定向证明显式使用 30 秒 test 与 hook 上限' },
    ],
  },
  {
    version: '0.5.75',
