...
5. Read the completion receipt. If it contains candidate IDs or reconciliation warnings, surface `maestro knowledge session {session_id}` as the review action; do not rewrite the same facts directly into spec/knowhow.
