...
- **Agent Teams**: before ending, send `shutdown_request` to each teammate — the team cleans up automatically on session exit; `SubagentStop` can be skipped for team members (#44971).
