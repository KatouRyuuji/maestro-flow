...
5. Review durable candidates with `maestro knowledge session <session_id>`; promote selected candidates explicitly. Session seal does not discard an unreviewed backlog.
