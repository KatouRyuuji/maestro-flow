...
function generateReference() {
  ...
  out += '> - `/spec-add` → `/maestro-spec "<constraint>"`; `/spec-load` → `maestro spec load`; `/spec-setup` → Read `~/.maestro/workflows/specs-setup.md` (skeleton only: `maestro spec init`); `/spec-remove` → step `specs-remove`\n';
