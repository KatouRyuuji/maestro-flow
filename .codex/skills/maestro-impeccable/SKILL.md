...
| W001 | warning | UI specs not found via maestro run skill --platform codex specs-load | Continuing without specs — output may miss project conventions |
...
Codify mode:
- [ ] UI specs loaded via `maestro run skill --platform codex specs-load --category ui` (if available)
