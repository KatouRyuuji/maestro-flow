...
TASK: • Load issue details via Maestro maestro-issue list • Analyze explorer context • Design solution approach • Break down into implementation tasks • Generate solution JSON • Record the Run artifact path on the issue
